...
export default function ServicesPage() {
  ...
  const openEdit = (service) => { setEditing(service); setForm({ name: service.name, price: service.price, is_active: service.is_active }); setImages(service.images ?? []); setImageUrl(''); setFeedback(''); setModalOpen(true) }
